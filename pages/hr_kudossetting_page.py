...
class HrKudosSetting(BasePage):
    ...
    def kudos_category(self):
        return self.page.get_by_role('link', name="+ Add Kudos Category")

    def category_name(self):
        return self.page.get_by_label("Category Name:")
    ...
    def delete_category(self):
        return self.page.get_by_role('row', name='Testing Employee Title 0 #').get_by_role('link').nth(1)
