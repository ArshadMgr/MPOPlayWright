...
def test_newhire_Setup(browser, fake_data,):
    ...
    editee_career = EditEECareerProfile(page)
    ...
    editee_career.navigate(BASE_URL + '/Sys/EmployerManager/Employees/EditEmployees.aspx')
    try:
        assert editee_career.verify_page_title("Edit Employees")
...
#add
    editee_career.ee_select().click()
    editee_career.select_careerprofile().click()
    editee_career.add_event().click()
    editee_career.add_summary().fill('Birthday')
