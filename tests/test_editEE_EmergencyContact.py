...
from MPOPlayWright.pages import login_page, editee_emergencycontact_page
...
from MPOPlayWright.pages.editee_emergencycontact_page import EditEEEEmergencyContact
...
def test_newhire_Setup(browser, fake_data,):
    ...
    editee_emergencycontact = EditEEEEmergencyContact(page)
    ...
    editee_emergencycontact.navigate(BASE_URL + '/Sys/EmployerManager/Employees/EditEmployees.aspx')
    try:
        assert editee_emergencycontact.verify_page_title("Edit Employees")
    ...
    editee_emergencycontact.ee_select().click()
    editee_emergencycontact.select_emergencycontacts().click()
    editee_emergencycontact.add_emergencycontacts().click()
    editee_emergencycontact.contactname().fill(first_name)
    editee_emergencycontact.select_relation().click()
    editee_emergencycontact.type_relation().fill("aunt")
    editee_emergencycontact.enter_relation().press("Enter")
    editee_emergencycontact.selectcountry().click()
    editee_emergencycontact.type_country().fill("am")
    editee_emergencycontact.enter_country().press("Enter")
    time.sleep(5)
    editee_emergencycontact.address1().fill(address)
    editee_emergencycontact.homephone().fill(phone_number)
    editee_emergencycontact.workphone().fill(phone_number)
    editee_emergencycontact.cellphone().fill(phone_number)
    editee_emergencycontact.email().fill(work_email)
    editee_emergencycontact.press_save().click()

    #edit

    editee_emergencycontact.edit_emergency().click()
    editee_emergencycontact.contactname().fill(first_name)
    editee_emergencycontact.select_relation().click()
    editee_emergencycontact.type_relation().fill("brother")
    editee_emergencycontact.enter_relation().press("Enter")
    editee_emergencycontact.selectcountry().click()
    editee_emergencycontact.type_country().fill("algeria")
    editee_emergencycontact.enter_country().press("Enter")
    time.sleep(5)
    editee_emergencycontact.address1().fill(address)
    editee_emergencycontact.homephone().fill(phone_number)
