...
from MPOPlayWright.pages import login_page, editee_perviousemployers_page
...
from MPOPlayWright.pages.editee_perviousemployers_page import EditEEPerviousEmployers
...
def test_newhire_Setup(browser, fake_data,):
    ...
    editee_perviousemployers = EditEEPerviousEmployers(page)
    ...
    editee_perviousemployers.navigate(BASE_URL + '/Sys/EmployerManager/Employees/EditEmployees.aspx')
    try:
        assert editee_perviousemployers.verify_page_title("Edit Employees")
    ...
    editee_perviousemployers.ee_select().click()
    editee_perviousemployers.edit_previous_employer().click()
    editee_perviousemployers.add_previous_employer().click()
    editee_perviousemployers.business_type().fill("Partnership")
    editee_perviousemployers.employer().fill(company)
    editee_perviousemployers.start_datee().fill("08/03/2024")
    editee_perviousemployers.salary().fill("700")
    editee_perviousemployers.select_salary_per().click()
    editee_perviousemployers.type_salryper().fill("Day")
    editee_perviousemployers.enter_salryper().press("Enter")
    editee_perviousemployers.job_titlee().fill("SQA Engineer")
    editee_perviousemployers.term_reason().fill("principle")
    editee_perviousemployers.phonee().fill(phone_number)
    editee_perviousemployers.supervisor().fill(first_name)
...
#edit
    ...
    editee_perviousemployers.business_type().fill("owner")
    editee_perviousemployers.employer().fill(company)
    editee_perviousemployers.start_datee().fill("09/04/2022")
    editee_perviousemployers.salary().fill("600")
    editee_perviousemployers.select_salary_per().click()
    editee_perviousemployers.type_salryper().fill("Day")
    editee_perviousemployers.enter_salryper().press("Enter")
    editee_perviousemployers.job_titlee().fill("Software Engineer")
    editee_perviousemployers.term_reason().fill("principle")
    editee_perviousemployers.phonee().fill(phone_number)
    editee_perviousemployers.supervisor().fill(first_name)
    editee_perviousemployers.duties().fill("Developing")
    editee_perviousemployers.notes().fill(note)
    editee_perviousemployers.press_save().click()
