...
from MPOPlayWright.pages.editee_beneficiaries_page import EditBeneficiaries
...
def test_newhire_Setup(browser, fake_data,):
    ...
    editee_beneficiaries = EditBeneficiaries(page)
    ...
    editee_beneficiaries.navigate(BASE_URL + '/Sys/EmployerManager/Employees/EditEmployees.aspx')
    try:
        assert editee_beneficiaries.verify_page_title("Edit Employees")
    ...
    editee_beneficiaries.ee_select().click()
    editee_beneficiaries.select_beneficiaries().click()
    editee_beneficiaries.add_beneficiaries().click()
    editee_beneficiaries.addfirst_name().fill(first_name)
    editee_beneficiaries.addlast_name().fill(last_name)
    editee_beneficiaries.gender_select().click()
    editee_beneficiaries.gender_type().fill("female")
    editee_beneficiaries.gender_enter().press("Enter")
    editee_beneficiaries.relation_select().click()
    editee_beneficiaries.relation_type().fill("ant")
    editee_beneficiaries.relation_enter().press("Enter")
    editee_beneficiaries.ssn_enter().type(ssn)
    editee_beneficiaries.date_enter().fill("04/02/1998")
    #newhire_page.address_enter().fill(address)
    editee_beneficiaries.city_name().fill(city)
    editee_beneficiaries.press_save().click()

#edit sections starts from here
    editee_beneficiaries.edit_button().click()
    editee_beneficiaries.addfirst_name().fill(first_name)
    editee_beneficiaries.addlast_name().fill(last_name)
    editee_beneficiaries.gender_select().click()
    editee_beneficiaries.gender_type().fill("female")
    editee_beneficiaries.gender_enter().press("Enter")
    editee_beneficiaries.relation_select().click()
    editee_beneficiaries.relation_type().fill("brp")
    editee_beneficiaries.relation_enter().press("Enter")
    editee_beneficiaries.ssn_enter().type(ssn)
    editee_beneficiaries.date_enter().fill("03/01/1988")
    #newhire_page.address_enter().fill(address)
    editee_beneficiaries.city_name().fill(city)
    editee_beneficiaries.press_save().click()

    # Delete
    editee_beneficiaries.delete_beneficiaries().click()
    editee_beneficiaries.enter_yes().click()
    editee_beneficiaries.page_pause()
