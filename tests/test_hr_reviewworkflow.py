...
from pages import login_page, hr_reviewworkflow_page
...
def test_newhire_Setup(browser, fake_data,):
    ...
    hr_reviewworkflow.workflow_name().fill("test name")
    ...
    hr_reviewworkflow.description().fill("Test descripation employer")
